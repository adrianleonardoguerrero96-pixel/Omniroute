...
- OpenAI-compatible API surface for CLI/tools (355 providers, 107 executors)
...
> **Note:** The matrix below is a representative sample of the 355 registered providers in
