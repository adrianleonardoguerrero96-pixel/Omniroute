...
**Honest headline:** _OmniRoute aggregates **~1.48B documented free tokens per month** (up to ~2.08B in your first month with signup credits) across 37 free-tier pools — plus a long tail of permanently-free, no-cap providers — and RTK + Caveman compression (15–95% token savings) stretches that further._
